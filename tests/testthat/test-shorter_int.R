test_that("int_build() | scalar test", {
  expect_equal(
    int_build(
...
test_that("int_build() | vector test", {
  expect_equal(
    int_build(
...
test_that("int_build() | warning test", {
  expect_message(int_build(
...
test_that("shorter_int() | general test", {
  expect_equal(
    shorter_int(
...
test_that("longer_int() | general test", {
  expect_equal(
    longer_int(
      x = lubridate::parse_date_time("01:10:00", "HMS"),
      y = lubridate::parse_date_time("11:45:00", "HMS")
