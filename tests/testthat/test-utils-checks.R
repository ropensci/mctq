test_that("check_any_na() and assert_any_na()", {
...
test_that("check_not_all_na() and assert_not_all_na()", {
...
test_that("check_length_one() and assert_length_one()", {
...
test_that("check_has_length() and assert_has_length()", {
...
test_that("check_whole_number() and assert_whole_number()", {
...
test_that("check_numeric_() and assert_numeric_()", {
...
test_that("check_duration() and assert_duration()", {
...
test_that("check_posixt() and assert_posixt()", {
...
test_that("test_time(), check_time() and assert_time()", {
...
test_that("check_custom_1() and assert_custom_1()", {
