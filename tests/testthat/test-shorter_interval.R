test_that("distance_interval() | scalar test", {
    expect_equal(distance_interval(
...
test_that("distance_interval() | vector test", {
    expect_equal(distance_interval(
...
test_that("distance_interval() | error test", {
    # checkmate::assert_multi_class(x, c("hms", "POSIXt"))
    expect_error(distance_interval(
...
test_that("distance_interval() | warning test", {
    expect_message(distance_interval(
