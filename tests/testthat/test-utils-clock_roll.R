...
test_that("clock_roll.Duration() | scalar test", {
...
test_that("clock_roll.difftime() | vector test", {
...
test_that("clock_roll.hms() | scalar test", {
...
test_that("clock_roll.hms() | vector test", {
