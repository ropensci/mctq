...
test_that("assign_date() | `ambiguity` test", {
    ...
    expected <- list(start = lubridate::as_datetime("0000-01-01 12:00:00"),
                     end = lubridate::as_datetime("0000-01-02 12:00:00"))
    expect_equal(object, expected)
})
