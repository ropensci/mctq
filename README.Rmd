...
MCTQ may look like a simple questionnaire, but it requires a lot of date/time manipulation. This can be real challenging, especially if you're dealing with a large set of data.
...
See a quick tour to all MCTQ main functions [here](https://gipsousp.github.io/mctq/articles/mctq.html).
