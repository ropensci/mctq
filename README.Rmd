...
If this package helps you in any way or you simply want to support the author work, please consider donating or even creating a membership subscription (if you can!). Your support will help with the author scientific pursuit and with the package maintenance.

To make a donation, click on the buymeacoffee.com button above. Please indicate the `mctq` package in your donation message.
