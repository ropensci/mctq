...
The difference described above may seems trivial or easy to compute, but it's not. See the `vignette("sjl", package = "mctq")` to learn more.
...
We have now processed all the MCTQ standard variables proposed by the original MCTQ authors.
...
If you're using [RStudio](https://rstudio.com/), you can run all the code showed above and them type `View(data)` in the console to explore the end result.
